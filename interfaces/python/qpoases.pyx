...
cdef class PyQProblemB:
    ...
    def __cinit__(self, int nV, HessianType hess_type = HST_UNKNOWN):
        # FIXME: allow other HessianTypes!
        self.thisptr = new QProblemB(nV, hess_type)
    def __dealloc__(self):
        del self.thisptr
...
cdef class PyQProblem:
    ...
    def __cinit__(self, int nV, int nC, HessianType hess_type = HST_UNKNOWN):
        self.thisptr = new QProblem(nV, nC, hess_type)
    def __dealloc__(self):
        del self.thisptr
...
cdef class PySQProblem:
    ...
    def __cinit__(self, int nV, int nC, HessianType hess_type = HST_UNKNOWN):
        self.thisptr = new SQProblem(nV, nC, hess_type)
    def __dealloc__(self):
        del self.thisptr
